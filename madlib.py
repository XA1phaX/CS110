...
print( (grammerfunc(adj3)) + adj3 + " hello; lightning flashed the trees below. The")
print("sound of a " + animal + " could be heard in the distance.\n")
print("It was Halloween night. I was dressed as " + (grammerfunc(noun1)) + noun1 + ". my bag")
...
print ("It opens with a " + adj5 + " man wearing " + (grammerfunc(noun3)) + noun3 + " looks at me.\n")
